...
Actual data: http://pr4e.dr-chuck.com/tsugi/mod/python-data/data/comments_170261.html (Sum ends with 84)
...
html = urllib.urlopen('http://pr4e.dr-chuck.com/tsugi/mod/python-data/data/comments_170261.html').read()
soup = BeautifulSoup(html)
tags = soup('span')
#print tags
#my_list = []
#for x in tags:
#	my_list.append(int(x.contents[0]))
# print sum(my_list)
#Above 4 lines in lambda below
print sum(map((lambda x: int(x.contents[0])), tags))
