...
# Write a script which parses /var/log/messages and generates a CSV with two columns: minute, number_of_messages in sorted time order.  (Max. Time: 15 mins)
# ---------- begin sample output ----------
...
print new_list
#Now we needed output in sorted format
print "minute, number_of_messages"
for time,count in new_list:
	print "Jan 20 %s,%s" %(time,count)
